...
import { toggleFav, addFav } from '../actions/favActions';
...
export default connect(mapStateToProps, { deleteMovie, addMovie, toggleFav, addFav })(Movie);